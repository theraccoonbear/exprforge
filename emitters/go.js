...
const emitter = new Emitter({
    ...
    formatFunction: (fn, body) => {
        ...
        // check is exact: omit the import when the body has no math calls,
        // or Go's "imported and not used" fails the build.
        const mathImport = body.includes("math.") ? `import "math"\n\n` : "";
