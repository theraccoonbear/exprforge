...
const emitter = new Emitter({
    ...
    formatFunction: (fn, body) => {
        ...
        // e.g. "P0"), and every bin node keeps explicit parens by design (see
        // header) — both trip default rustc lints without being bugs, so
        // silence them rather than let a `-D warnings` build choke on them.
